...
// Data
$data_sql[0] = "INSERT INTO `downloads_categories` (`id`, `parent_id`, `name`, `description`, `sort`) 
VALUES (1, 0, 'Test Parent 1', 'Test category 1', 2);";

$data_sql[1] = "INSERT INTO `downloads_files` (`id`, `category_id`, `name`, `description_small`, `description_big`, `downloads`, `views`, `size`, `date`, `agreement_id`, `rating_votes`, `rating_value`, `password`) 
VALUES (1, 1, 'Test File 1', 'This is a short description. This is a \r\n\r\nshort description. This is a short description. This is a short description. This is a short \r\n\r\ndescription.', 'This is a longer description. This is a longer description. This is a longer \r\n\r\ndescription. This is a longer description. This is a longer description. This is a longer description. \r\n\r\nThis is a longer description. \r\n\r\nThis is a longer description. This is a longer description. This \r\n\r\nis a longer description. This is a longer description. This is a longer description.', 0, 0, 150, 1093290536, 0, 0, '', '');";

$data_sql[2] = "INSERT INTO `downloads_mirrors` (`id`, `file_id`, `name`, `location`, `url`) 
VALUES (1, 1, 'Mirror 1', 'Mirror 1', 'http://www.example.com');";

$data_sql[3] = "INSERT INTO `downloads_permissions` (`permission_id`, `name`, `setting`) 
VALUES (1, 'acp_view', 0),
...
(32, 'acp_languages', 0),
(33, 'acp_edit_secure_key', 0);";

$data_sql[4] = "INSERT INTO `downloads_usergroups` (`id`, `name`) 
VALUES (1, 'Members'),
(2, 'Admins');";

$data_sql[5] = "INSERT INTO `downloads_userpermissions` (`id`, `permission_id`, `type`, `type_value`, `setting`) VALUES (1, 1, 'user_group', 2, 1),
(2, 2, 'user_group', 2, 1),
(3, 3, 'user_group', 2, 1),
(4, 4, 'user_group', 2, 1),
(5, 5, 'user_group', 2, 1),
...
$data_sql[6] = 'INSERT INTO `downloads_languages` VALUES (\'\', \'English (British)\', 1, \'english.php\', 3, 4);';
?>