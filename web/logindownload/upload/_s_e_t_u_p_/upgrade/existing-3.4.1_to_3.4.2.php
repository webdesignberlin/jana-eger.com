...
$dbim->query('ALTER TABLE '.DB_PREFIX.'config ADD `secure_key` VARCHAR( 100 ) NOT NULL AFTER `version`');
$dbim->query('UPDATE '.DB_PREFIX.'config SET secure_key = \''.md5(microtime()).'\'');

$dbim->query(" INSERT INTO ".DB_PREFIX."permissions (`permission_id` ,`name` ,`setting`)
VALUES (NULL , 'acp_edit_secure_key', '0')");
...
<tr>
	...
	<td id="content">
		...
		<p id="intro">The upgrade from 3.4.1 to 3.4.2 has been completed<a href="index.php"></a> successfully. However, before you can login again, you must take the following actions: </p>
		<br />
        <div id="options">
          <h3>Actions</h3>
          ...
          <h3>What's New?</h3>
          <p>Just a security update with a new auto-login cookie encryption.</p>
        </div>
	</td>
</tr>
</table>
