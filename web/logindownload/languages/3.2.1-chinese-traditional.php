...
// Language details
$language['config']['full_name']	= 'Chinese (Traditional)'; 		// Full Language Name
$language['config']['short_name']	= 'chinese-traditional';				// Short name (lowercase, no spaces or symbols)
